...
import Leaderboard from "@/app/_components/atoms/leaderboard";
  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center align-center">
        <SvgIcon
          className="w-[91px] h-[115px] text-[#5392D3]"
          name="standings"
        />
        <p className="text-[20px] font-flick text-cpb-basewhite mix-blend-overlay drop-shadow-md">
          Coming Soon
        </p>
        <h1 className="text-[50px] font-flick leading-[50px] drop-shadow-md">
          Standings
        </h1>
        <div className="mx-10 flex flex-col items-center justify-center align-center bg-[#5392D380] text-color-cpb-basewhite font-bold text-[16px] p-4 rounded-lg mt-6 relative">
          ...
          <p className="max-w-[80%] mr-auto">Score bonus coins for topping the leaderboards.</p>
        </div>
      </div>
      <Leaderboard />
    </div>
