...
const WinView = () => {
  return (
    <div>
      ...
      <div className="mx-10 flex flex-col items-center justify-center align-center bg-[#8971D780] text-color-cpb-basewhite font-bold text-[16px] p-4 rounded-lg mt-6 relative">
